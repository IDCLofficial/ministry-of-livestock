...
const stats = [
  { value: 15000, suffix: "+", desc: "Livestock Farmers Supported" },
  { value: 85, suffix: "%", desc: "Increase in Livestock Production" },
  { value: 250, suffix: "+", desc: "Veterinary Clinics Established" },
  { value: 50000, suffix: "+", desc: "Animals Vaccinated Annually" },
];
